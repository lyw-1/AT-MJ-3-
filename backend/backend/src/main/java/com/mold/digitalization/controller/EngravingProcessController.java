...
@RestController
@RequestMapping("/api/process/engraving")
public class EngravingProcessController extends BaseController {

    @Autowired
    private EngravingProcessService service;

    @PostMapping("/start")
    public ResponseEntity<EngravingProcess> start(@RequestBody Map<String, Object> payload) {
        ...
        EngravingProcess p = service.start(moldCode, equipmentId, equipmentName, stage, expectedFinishTime);
